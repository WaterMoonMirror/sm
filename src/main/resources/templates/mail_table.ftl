...
<head>
    ...
    <!-- jqgrid-->
    <link href="${request.contextPath }/css/plugins/jqgrid/ui.jqgrid.css?0820" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Peity -->
    <script src="${request.contextPath }/js/plugins/peity/jquery.peity.min.js"></script>

    <!-- jqGrid -->
    <script src="${request.contextPath }/js/plugins/jqgrid/i18n/grid.locale-cn.js?0820"></script>
    <script src="${request.contextPath }/js/plugins/jqgrid/jquery.jqGrid.min.js?0820"></script>
